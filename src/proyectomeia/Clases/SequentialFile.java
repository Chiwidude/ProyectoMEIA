 ...
 */
    ...
    /**
        * Metodo ObtenerCantidadUsuarios
        * Funcion: Este metodo permite obtener la cantidad de usurioas registrados
        * en el archivo secuencial
        */
    ...
    /**
        ...
        * @param llave
        * Funcion: Este metodo permite leer el archivo de usuarios y buscar el usuarios deseado
        * segun su llave
        */
    ...
    /**
        ...
        * @param rutaFoto 
        * @param status 
        * Funcion: Este metodo permite modificar el archivo secuencial, dependiendo los atributos que el usuarios indique
        * o el cambio de informacion que desee
        */
