...
public class Bitacora_lista extends ApiloFile {
    ...
    @Override
    /**
     * Realiza una busqueda de registros según el número de llaves
     * que debe cumplir 
     * Parametro: linea completa registro a buscar
     * Retorna, lista con todos los registros, activos o eliminados
     */
